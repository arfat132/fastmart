...
export default function Layout({ title, children }) {
    ...
    return (
        <>
            <Head>
                <title>{title ? title + '- Fastmart' : 'Fastmart'}</title>
                ...
                <header class="text-gray-600 body-font shadow-lg">
                    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                        ...
                        <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
                            <Link href="/cart" ><a class="mr-5 hover:text-teal-500">Cart
                            ...
                            <Link href="/login"><a class="mr-5 hover:text-teal-500">Login</a></Link>
                        </nav>
                    </div>
                </header>
                <main className='p-12'>{children}</main>
                <footer class="text-white body-font bg-slate-900 mt-36">
                    <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                        ...
                        <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                                <h2 class="title-font font-medium text-teal-500 tracking-widest text-sm mb-3">CATEGORIES</h2>
                    ...
                    <div class="bg-slate-900 border-t">
